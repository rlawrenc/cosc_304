...
| June 7 (T) | [Database Web Programming – Web servers, JSP/PHP (L12)](lectures/lecture12) <br> [Database Programmin using APEX](lectures/lecture11)  | [Sample JSP/PHP Code](lectures/lecture12/code)<br> [Comic - Why validation is important](http://xkcd.com/327/)<br> [Oracle APEX Curricululum](https://ubcca-my.sharepoint.com/:f:/r/personal/youry_khmelevsky_ubc_ca/Documents/COSC%20304/apex-curriculum?csf=1&web=1&e=0vRb8U) |
