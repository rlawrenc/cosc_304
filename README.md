...
| Oct. 5 | [SQL - Group By, Aggregate Functions](lectures/lecture6) | [SQL for Web Nerds: SQL Complex Queries](http://philip.greenspun.com/sql/complex-queries.html) |
| Oct. 7 | [SQL - Subqueries, Outer joins](lectures/lecture6) | |
| Oct. 12 | [Database Design – General Approach ; ER and UML Modeling](lectures/lecture7) | |
| Oct. 14 | [ER and UML Modeling examples and questions](lectures/lecture8) | |
