...
<br>Lab 4: Building ER diagrams using an UML modeling tool</h1>
<hr>


<p>This lab designs ER diagrams in UML notation using <a href="http://astah.net/editions">astah</a>. <strong>Note: Astah no longer has a free community version. Request a student license or use the 30-day trial.</strong> <a href="https://www.draw.io/">draw.io</a> is an online drawing tool that can also be used but it does not have as good support for database modeling in UML.</p>
