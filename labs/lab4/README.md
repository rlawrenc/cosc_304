...
This lab designs ER diagrams in UML notation. Students participating in the AutoER study can use the AutoER Designer and Evaluator software that performs real-time marking and feedback. If you have not signed up, fill out the [consent form](https://ubc.ca1.qualtrics.com/jfe/form/SV_56kKBoxF28OxHTg). <!-- [Instructor and Teaching Assistant consent form](https://ubc.ca1.qualtrics.com/jfe/form/SV_9BHztD5zFmKCd14)--> <strong>A video on how to use the AutoER system is in Canvas.</strong></p>
