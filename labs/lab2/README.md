...
<li>*For MySQL database only (Oracle doesn't have ON UPDATE CASCADE option):* Change the name of the course <tt>'Database Systems'</tt> to <tt>'Introduction to Database Systems'</tt>.  Update all affected records.</li>
