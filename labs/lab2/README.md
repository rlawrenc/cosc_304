...
**Note: You can do the lab and practice questions on PrairieLearn without setting up a MySQL database using Docker. However, it is recommended to set up your environment as you will need it for future labs.**
...
It is recommended to complete the lab on [PrairieLearn](https://plcanary.ok.ubc.ca/pl/course_instance/12/assessment/299). You may also use [MySQL on Docker](setup/) that **requires computer setup by following these [setup instructions](../setup).**
